document.addEventListener("DOMContentLoaded", function () {
    const mediaSources = [
        ...
        { type: 'video', src: 'slides/Slide 5_compressed.mp4', url: 'https://vimeo.com/charlygutierrez' },
        { type: 'video', src: 'slides/Slide 6_compressed.mp4', url: 'https://polleri.com/' },
        { type: 'video', src: 'slides/Slide 7_compressed.mp4', url: 'https://ceciliaguerriero.com/' },
        { type: 'video', src: 'slides/Slide 8_compressed.mp4', url: 'https://vimeo.com/valeluque' },
        ...
        { type: 'video', src: 'slides/Slide 12_compressed.mp4', url: 'https://f.io/G6siGFMa' },
        { type: 'video', src: 'slides/Slide 13_compressed.mp4' },
        { type: 'video', src: 'slides/Slide 14_compressed.mp4', url: 'https://f.io/VFzvrSB7' },
        { type: 'video', src: 'slides/Slide 15_compressed.mp4', url: 'https://f.io/op8HUcWo' },
        { type: 'video', src: 'slides/Slide 16_compressed.mp4', url: 'https://www.lamayor.com.uy/' },
        { type: 'video', src: 'slides/Slide 17_compressed.mp4', url: 'https://f.io/obsRFWLP' },
        { type: 'video', src: 'slides/Slide 18_compressed.mp4', url: 'https://www.orientalfilms.tv' }
    ];
